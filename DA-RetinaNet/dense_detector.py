...
class DenseDetector(nn.Module):
    ...
    def forward(self, batched_inputs: List[Dict[str, Tensor]], domain_target = False, alpha3 = 1, alpha4 = 1, alpha5 = 1):
        """
        Args:
        ...
        if self.training:
            ...
            if domain_target:
                ...
                loss_discriminators = {"loss_r3": loss_res3, "loss_r4": loss_res4, "loss_r5": loss_res5}
        ...
        if self.training:
            ...
            losses.update(loss_discriminators)
            return losses
        else:
